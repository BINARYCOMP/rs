...
<head>
  ...
  <title><?php echo e($title); ?> | Log in</title>
  ...
  <div class="login-box-body">
    ...
    <form action="<?php echo e(route('auth.login.post')); ?>" method="post">
      ...
      <div class="form-group has-feedback">
        <input type="email" name="txtEmail" value="<?php echo e(old('txtEmail')); ?>" class="form-control" placeholder="Email">
        <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
      </div>
      <div class="form-group has-feedback">
        <input type="password" name="txtPassword" value="<?php echo e(old('txtPassword')); ?>" class="form-control" placeholder="Password">
